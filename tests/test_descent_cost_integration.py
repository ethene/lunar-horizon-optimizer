...
class TestDescentCostIntegration:
    ...
    def test_basic_descent_cost_calculation(self):
        ...
        descent_params = {"thrust": 15000.0, "isp": 300.0, "burn_time": 300.0}
        ...
        descent_total = (
            breakdown_with["descent_propellant_cost"]
            + breakdown_with["lander_hardware_cost"]
        )
    ...
    def test_descent_cost_breakdown(self):
        ...
        calculator = create_cost_calculator(
            propellant_unit_cost=20.0, lander_fixed_cost=12e6
        )

        descent_params = {"thrust": 18000.0, "isp": 330.0, "burn_time": 420.0}
        ...
        total_descent = (
            breakdown["descent_propellant_cost"] + breakdown["lander_hardware_cost"]
        )
    ...
    def test_propellant_mass_calculation(self):
        ...
        for params in test_cases:
            ...
            expected_cost = (
                min(max(expected_mass, 50.0), 2000.0) * calculator.propellant_unit_cost
            )
    ...
    def test_parameter_sensitivity(self):
        ...
        calculator = create_cost_calculator(
            propellant_unit_cost=25.0, lander_fixed_cost=15e6
        )

        base_params = {"thrust": 15000.0, "isp": 300.0, "burn_time": 300.0}
    ...
    def test_json_scenario_with_descent(self):
        ...
        scenario_json = {
            ...
            "descent_parameters": {"thrust": 18000.0, "isp": 330.0, "burn_time": 420.0},
            "orbit": {
...
"""
    ...
    def test_edge_cases_and_bounds(self):
        ...
        assert (
            propellant_cost >= 50.0 * calculator.propellant_unit_cost
        )  # Min mass bound
        ...
        assert (
            propellant_cost <= 2000.0 * calculator.propellant_unit_cost
        )  # Max mass bound
        assert hardware_cost == calculator.lander_fixed_cost
    ...
    def test_financial_integration_with_descent(self):
        ...
        descent_params = {"thrust": 20000.0, "isp": 340.0, "burn_time": 450.0}
        ...
        cash_flow_model.add_development_costs(
            total_cost=850000000.0, start_date=start_date, duration_months=36
        )
        ...
        cash_flow_model.add_launch_costs(
            cost_per_launch=total_cost, launch_dates=[launch_date]
        )

        # Add revenue stream
        revenue_start = launch_date + timedelta(days=30)
        cash_flow_model.add_revenue_stream(
            monthly_revenue=15000000.0, start_date=revenue_start, duration_months=60
        )
    ...
    def test_multi_mission_descent_costs(self):
        ...
        calculator = create_cost_calculator(
            propellant_unit_cost=21.0, lander_fixed_cost=11000000.0
        )
