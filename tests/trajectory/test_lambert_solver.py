...
class TestLambertSolver:
    ...
    def test_circular_orbit_validation(self):
        ...
        logger.info(f"Circular Orbit Test Parameters:")
        ...
        logger.info(f"Lambert solution velocities:")
    ...
    def test_coplanar_transfer_validation(self):
        ...
        logger.info(f"Coplanar Transfer Test Parameters:")
        ...
        logger.info(f"Angular Momentum Analysis:")
    ...
    def test_hohmann_velocity_checks(self):
        ...
        logger.info(f"Transfer Orbit Analysis:")
    ...
    def test_lunar_transfer(self):
        ...
        logger.info(f"Lunar Transfer Test Parameters:")
