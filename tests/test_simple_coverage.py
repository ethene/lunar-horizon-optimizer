...
def test_import_all_major_modules():
    ...
    from src.trajectory import (
        celestial_bodies,
        defaults,
        earth_moon_trajectories,
        generator,
    )
    from src.trajectory import lambert_solver, nbody_dynamics, nbody_integration
    from src.trajectory import (
        phase_optimization,
        propagator,
        target_state,
    ...
    from src.trajectory import (
        transfer_parameters,
        transfer_window_analysis,
        validator,
        validators,
    )
    from src.trajectory.validation import (
